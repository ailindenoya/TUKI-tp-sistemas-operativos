...
void ejecutar_MOV_IN(t_contexto* pcb, char* reg, char* dirLogica);
void ejecutar_MOV_OUT(t_contexto* pcb, char* dirLogica, char* regALeer);
void ejecutar_CREATE_SEGMENT(t_contexto* pcb, char* Idsegmento, char* tamanio);
